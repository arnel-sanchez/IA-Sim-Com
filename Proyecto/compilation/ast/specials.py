...
class RiderNode(TypeSpecial):
    def __init__(self):
        ...
        self.varsforRiders = [["speed", VariableType.DOUBLE, 0.0], ["acceleration", VariableType.DOUBLE, 0.0],
                              ...
                              ["step_by_line", VariableType.INT, 5],["probability_of_falling_off_the_bike", VariableType.INT, 5],
                              ["independence", VariableType.INT, 5]
                              ,["expertise", VariableType.INT, 5],["aggressiveness", VariableType.INT, 5],
                              ["length", VariableType.DOUBLE, 0.0],["max_speed", VariableType.DOUBLE,0.0],
                              ["orientation", VariableType.INT, 0],["type", VariableType.INT, 0],
                              ["pit_line", VariableType.BOOL, False],["pit_line_length", VariableType.DOUBLE,0.0]                            
                              ]
