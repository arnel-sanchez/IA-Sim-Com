...
class Test_tokenizer(unittest.TestCase):
    def test_A(self):
        ...
        tokens_ref.append(Token(TokenType.T_INT, 1,3, 1))
    ...
    def test_B(self):
        ...
        tokens_ref.append(Token(TokenType.T_INT, 1,24, "22"))
        tokens_ref.append(Token(TokenType.T_DOUBLE, 1,27, "3.4"))
        ...
        tokens_ref.append(Token(TokenType.T_STRING, 1,46, "AAA"))
        tokens_ref.append(Token(TokenType.T_ID, 1,51, "aaa"))
        tokens_ref.append(Token(TokenType.T_DOUBLE, 2,1, "123.0"))
